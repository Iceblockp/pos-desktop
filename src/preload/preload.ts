...
const api: DesktopApi = {
  ...
  pos: {
    ...
    suppliers: () => ipcRenderer.invoke('pos:suppliers'),
    ...
    adjustStock: (productId, quantityDelta, type, reason) => ipcRenderer.invoke('pos:adjust-stock', productId, quantityDelta, type, reason),
